...
<div class="card animate__animated animate__pulse">
    <div class="card-header bg-white py-3">
        <h4 class="mb-0 text-custom fw-bold">Edit Matakuliah</h4>
    </div>
    <div class="card-body">
        <form action="{{ route('matakuliah.update', $matakuliah->id_matakuliah) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="sks" min="1" max="6" class="form-control @error('sks') is-invalid @enderror" value="{{ old('sks', $matakuliah->sks) }}">
